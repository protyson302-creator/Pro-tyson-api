...
# ============ CONFIGURATION ============
API_URL = "https://pro-tyson-api.vercel.app/"
ENCODED_KEY = "WkVYWFk="
API_KEY = base64.b64decode(ENCODED_KEY).decode()

BOT_TOKEN = "8960134553:AAGidpjdU6QK4Akn7UCKpaSbjL6S0FMRuIg"
ADMIN_IDS = [7945931354]          # ← Replace with your actual admin ID(s)
